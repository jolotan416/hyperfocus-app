package com.spotlight.spotlightapp.task.views.delegation
...
import com.spotlight.spotlightapp.task.viewmodels.delegation.PendingTaskListViewModel
import com.spotlight.spotlightapp.utilities.viewmodelutils.ViewModelErrorListenerDelegate
...
class PendingTaskListFragment(private val taskPageRouter: TaskPageRouter)
    ...
    private val errorListener: ViewModelErrorListenerDelegate by viewModelErrorListener()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        configureViews()
        initializeViewModel()
        errorListener.observeErrors(viewModel, viewBinding.root)
    }
